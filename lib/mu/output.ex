...
defmodule Mu.Output.SemanticColors do
  @moduledoc """
  ...
  import Mu.Output.Macros, only: [color: 2]
...
defmodule Mu.Output.AdminTags do
  @moduledoc """
  ...
  import Mu.Output.Macros, only: [metadata: 3]
...
defmodule Mu.Output.Tooltips do
  @moduledoc """
  ...
  # import Mu.Output.Macros, only: [tooltip: 2]
...
defmodule Mu.Output.Commands do
  @moduledoc """
